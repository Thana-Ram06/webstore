...
export default function SettingsPage() {
  ...
  // Populate form once profile/user loads
  useEffect(() => {
    if (!profileLoading) {
  ...
  async function handleSave() {
    ...
    const result = profileUpdateSchema.safeParse({ displayName, bio: bio || undefined, websiteUrl: websiteUrl || undefined })
    if (!result.success) {
    ...
    <div className="mx-auto max-w-xl space-y-8">
      ...
      <div className="space-y-5 rounded-xl border border-border bg-card p-5">
        ...
        <Input
          ...
          maxLength={50}
          hint="Shown on your submissions and reviews."
        />
        ...
        <Input
          ...
          type="url"
          hint="Optional. Your personal site or portfolio."
        />
      </div>
